...
run_clustifyr_jaccard_database_function <- function(seurat_train, seurat_test, markers) {
  ...
  # Step 1: Use Ground_Truth_Celltype as cluster assignments
  n_test_clusters <- length(unique(seurat_test@meta.data[["Ground_Truth_Celltype"]]))
  ...
  # Add rank column for wide format conversion
...
run_clustifyr_jaccard_database <- run_clustifyr_jaccard_database_function

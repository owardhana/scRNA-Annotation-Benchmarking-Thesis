...
run_scPred_avNNet_function <- function(seurat_train, seurat_test, markers) {
  ...
  if (!requireNamespace("peakRAM", quietly = TRUE)) {
    ...
    seurat_train <- trainModel(seurat_train, model = "avNNet", allowParallel = TRUE)
  ...
  return(list(
    ...
    warning(paste("scPred (avNNet) error:", e$message))
    return(default_return())
  })
}

# For backward compatibility
run_scPred_avNNet <- run_scPred_avNNet_function

...
run_scPred_svmPoly_function <- function(seurat_train, seurat_test, markers) {
  ...
  if (!requireNamespace("peakRAM", quietly = TRUE)) {
    ...
    seurat_train <- trainModel(seurat_train, model = "svmPoly", allowParallel = TRUE)
  ...
  return(list(
    ...
    warning(paste("scPred (svmPoly) error:", e$message))
    return(default_return())
  })
}

# For backward compatibility
run_scPred_svmPoly <- run_scPred_svmPoly_function

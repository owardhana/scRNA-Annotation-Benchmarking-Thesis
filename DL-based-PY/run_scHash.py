...
try:
    ...
    datamodule = scHash.setup_training_data(
        ...
        batch_key='batch',      # Point to dummy batch column
        log_norm=False,         # Data already log-normalized in benchmarking framework
        hvg=False,              # Use all common genes for consistency across folds
        normalize=True,         # Keep StandardScaler normalization
        batch_size=128
    )

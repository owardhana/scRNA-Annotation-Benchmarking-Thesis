...
try:
    ...
    # Setup the reference data (use counts layer)
    ...
    scvi_ref.train(max_epochs=100)  # Reduced for benchmarking speed

    # ============================================
    # PART 2: Initialize and train SCANVI
    # ============================================

    # Initialize SCANVI from the pre-trained SCVI model
    scanvi_ref = scvi.model.SCANVI.from_scvi_model(
        scvi_ref,
        unlabeled_category="Unknown",
        labels_key="Ground_Truth_Celltype",
    )

    # Train SCANVI (all cells are labeled in reference)

...
sce <- fetchDataset("he-organs-2020", '2023-12-21', path = 'blood', realize.assays=TRUE)
...
cell_type_column <- "reclustered.fine"  # Update this if the column name is different

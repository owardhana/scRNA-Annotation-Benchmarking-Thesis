...
sce <- fetchDataset("nowakowski-cortex-2017", '2023-12-22', path = NA, realize.assays=TRUE)

# Print assays for verification
assayNames(sce)

seurat_obj <- as.Seurat(sce, counts = "tpm", data = NULL)

# FIND OUT THE NAME OF THE METADATA COLUMN THAT HAS THE CELL TYPE INFO
head(seurat_obj@meta.data)
cell_type_column <- "WGCNAcluster"  # Update this if the column name is different

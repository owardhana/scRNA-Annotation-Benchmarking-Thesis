...
sce <- fetchDataset("zilionis-lung-2019", '2023-12-20', path = 'human', realize.assays=TRUE)
...
cell_type_column <- "Most.likely.LM22.cell.type"  # Update this if the column name is different

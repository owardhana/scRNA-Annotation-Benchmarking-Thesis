...
sce <- fetchDataset("he-organs-2020", '2023-12-21', path = 'stomach', realize.assays=TRUE)
...
cell_type_column <- "reclustered.broad"  # Update this if the column name is different

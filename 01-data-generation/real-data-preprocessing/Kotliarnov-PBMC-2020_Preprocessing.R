...
sce <- fetchDataset("kotliarov-pbmc-2020", '2024-04-18', path = NA, realize.assays=TRUE)
...
cell_type_column <- "hto_classification"  # Update this if the column name is different

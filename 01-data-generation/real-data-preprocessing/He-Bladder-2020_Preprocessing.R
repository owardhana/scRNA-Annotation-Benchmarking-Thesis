...
sce <- fetchDataset("he-organs-2020", '2023-12-21', path = 'bladder', realize.assays=TRUE)
...
cell_type_column <- "Cell_type_in_merged_data"  # Update this if the column name is different

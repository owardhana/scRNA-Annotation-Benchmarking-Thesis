...
# ==============================================================================
# 1. Load and Convert + Ortholog Matching
# ==============================================================================
# This pulls the RDS directly into your R environment
sce <- fetchDataset("marques-brain-2016", '2023-12-19', path = NA, realize.assays=TRUE)
...
#Remove Rik Genes
seurat_obj <- seurat_obj[!grepl("Rik$", rownames(seurat_obj), ignore.case = TRUE), ]
nrow(seurat_obj)

# FIND OUT THE NAME OF THE METADATA COLUMN THAT HAS THE CELL TYPE INFO
head(seurat_obj@meta.data)
cell_type_column <- "inferred.cell.type"  # Update this if the column name is different

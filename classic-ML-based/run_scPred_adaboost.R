...
run_scPred_adaboost_function <- function(seurat_train, seurat_test, markers) {
  ...
  if (!requireNamespace("peakRAM", quietly = TRUE)) {
    ...
    seurat_train <- trainModel(seurat_train, model = "adaboost", allowParallel = TRUE)
  ...
  return(list(
    ...
    warning(paste("scPred (adaboost) error:", e$message))
    return(default_return())
  })
}

# For backward compatibility
run_scPred_adaboost <- run_scPred_adaboost_function

...
#'            Multinomial logistic regression via nnet package
run_scPred_multinom_function <- function(seurat_train, seurat_test, markers) {
  ...
  if (!requireNamespace("peakRAM", quietly = TRUE)) {
    ...
    seurat_train <- trainModel(seurat_train, model = "multinom", allowParallel = TRUE)
  ...
  return(list(
    ...
    warning(paste("scPred (multinom) error:", e$message))
    return(default_return())
  })
}

# For backward compatibility
run_scPred_multinom <- run_scPred_multinom_function

...
run_scPred_glm_function <- function(seurat_train, seurat_test, markers) {
  ...
  if (!requireNamespace("bench", quietly = TRUE)) {
    ...
    seurat_train <- trainModel(seurat_train, model = "glm", allowParallel = TRUE)
  ...
  return(list(
    ...
    warning(paste("scPred (glm) error:", e$message))
    return(default_return())
  })
}

# For backward compatibility
run_scPred_glm <- run_scPred_glm_function

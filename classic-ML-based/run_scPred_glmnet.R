...
run_scPred_glmnet_function <- function(seurat_train, seurat_test, markers) {
  ...
  if (!requireNamespace("peakRAM", quietly = TRUE)) {
    ...
    seurat_train <- trainModel(seurat_train, model = "glmnet", allowParallel = TRUE)
  ...
  return(list(
    ...
    warning(paste("scPred (glmnet) error:", e$message))
    return(default_return())
  })
}

# For backward compatibility
run_scPred_glmnet <- run_scPred_glmnet_function

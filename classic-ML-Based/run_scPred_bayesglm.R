...
run_scPred_bayesglm_function <- function(seurat_train, seurat_test, markers) {
  ...
  if (!requireNamespace("bench", quietly = TRUE)) {
    ...
    seurat_train <- trainModel(seurat_train, model = "bayesglm", allowParallel = TRUE)
  ...
  return(list(
    ...
    warning(paste("scPred (bayesglm) error:", e$message))
    return(default_return())
  })
}

# For backward compatibility
run_scPred_bayesglm <- run_scPred_bayesglm_function
